...
c1 = Camera.objects.create(name="Front Door Entrance", location="Building A, Floor 1", status="active", stream_url="/static/mock_feed.mp4")
c2 = Camera.objects.create(name="Parking Lot West", location="Outdoor", status="active", stream_url="/static/mock_feed_2.mp4")
c3 = Camera.objects.create(name="Server Room", location="Building B, Floor 3", status="active", stream_url="/static/mock_feed_3.mp4")
